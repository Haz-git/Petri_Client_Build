...
class MainDashboard extends Component {
    ...
    componentDidMount() {
        if (
            ...
            this.setState({ loading: true }, () => {
                this.props.userGetProfilePicture().then((result) => {
    ...
    renderDashBoardProfilePicture = () => {
        if (
            this.props.userDetails.profileImg.url !== undefined &&
            this.props.userDetails.profileImg.url !== null
        ) {
...
export default connect(mapStateToProps, { userGetProfilePicture })(
    MainDashboard
);
