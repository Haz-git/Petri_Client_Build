    ...
    return (
        <>
            <MainPPConfigHeaderContainer>
                <StyledMainHeader>Profile Picture Configuration</StyledMainHeader>
            </MainPPConfigHeaderContainer>
                    ...
                    <div>
                        ...
                        <div>
                            ...
                            <Slider
                                ...
                                onChange={(event, value) => handleZoomChange(value)}
                            />
                        </div>
                        <ButtonContainer>
                            <RotateButtonContainer>
                                <ButtonDivider>
                                    <Button variant='dark' onClick={handleRotateLeft}>Rotate Left</Button >
                                </ButtonDivider>
                                <ButtonDivider>
                                    <Button variant='dark' onClick={handleRotateRight}>Rotate Right</Button >
                                </ButtonDivider>
                            </RotateButtonContainer>
                            <SaveButtonContainer>
                                <ButtonDivider>
                                    <Button variant='primary' onClick={handleSaveAndPreview}>Preview</Button>
                                </ButtonDivider>
                                <ButtonDivider>
                                    <Button variant='success' onClick={handleSave}>Save Profile Picture</Button>
                                </ButtonDivider>
                            </SaveButtonContainer>
                        </ButtonContainer>
                    </div>
